  ...
  const handleWeightDecrement = () => {
    setUserInfo((prevState) => ({
      ...
      startingWeight: String(
        Math.max(0, Number(prevState.startingWeight) - 0.5)
      ), // Prevents negative values, adjust as needed
    }));
  };
            ...
            <form class="max-w-sm mx-auto" onSubmit={handleSubmit}>
              ...
              <div class="flex mb-4">
                ...
                <input
                  ...
                  class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-base p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              ...
              >
                Choose your starting weight (kg):
              </label>
              <div class="relative flex items-center mb-4 flex justify-center">
                <button
                  ...
                  data-input-counter-decrement="startingWeight"
                ...
                <input
                  ...
                  type="text"
                  data-input-counter
                  class="flex-shrink-0 text-gray-900 dark:text-white border-0 bg-transparent text-base font-normal focus:outline-none focus:ring-0 max-w-[2.5rem] text-center"
                  placeholder=""
                  required
                />
                <button
                  ...
                  data-input-counter-increment="startingWeight"
                  class="flex-shrink-0 bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 inline-flex items-center justify-center border border-gray-300 rounded-md h-5 w-5 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none"
                >
                  <svg
                    class="w-2.5 h-2.5 text-gray-900 dark:text-white"
              ...
              <label
                ...
                class="block mb-1 text-base font-medium text-gray-900 dark:text-white"
              >
                Choose your starting height (cm):
              </label>
              <div class="relative flex items-center mb-4 flex justify-center">
                <button
                  type="button"
                  ...
                  data-input-counter-decrement="startingHeight"
                  class="flex-shrink-0 bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 inline-flex items-center justify-center border border-gray-300 rounded-md h-5 w-5 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none"
                >
                  <svg
                    class="w-2.5 h-2.5 text-gray-900 dark:text-white"
                ...
                <button
                  ...
                  data-input-counter-increment="startingHeight"
                  class="flex-shrink-0 bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 inline-flex items-center justify-center border border-gray-300 rounded-md h-5 w-5 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none"
                >
                  <svg
                    class="w-2.5 h-2.5 text-gray-900 dark:text-white"
              ...
              {showSuccessAlert && (
                <div
                  class="p-4 mt-4 mb-4 text-base text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400"
                  role="alert"
                >
                  <span class="font-medium">Success alert!</span> Your
