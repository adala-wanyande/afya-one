...
const Dashboard = () => {
  ...
  return (
    <div className='mx-8 lg:mx-36 scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-8'>
      {firstName ? <h1>Welcome back, {firstName} 👋! </h1> : <div className='flex justify-center mt-32'>
        <div role="status">
